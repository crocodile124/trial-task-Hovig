...
const Header = () => {
  ...
  const metamaskButton = (
    <div className="flex justify-center items-center p-3 mb-0 border-2 border-solid border-pink-400 rounded-2xl cursor-pointer">
      <div style={{ display: "flex" }}>
        ...
        <button
          className="bg-none text-black border-none cursor-pointer text-lg ml-4"
  ...
  return (
    <header className="h-20 absolute top-0 w-full bg-transparent flex items-center justify-center">
      <nav className="h-full flex justify-between container items-center">
        <p className="text-[50px]">Trial</p>
